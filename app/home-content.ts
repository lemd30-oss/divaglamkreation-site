...
export const products: Product[] = [
  ...
  {
    title: 'The Gentle Reset — The Book',
    description: 'A 7-day guided journal for faith, reflection, and renewal, with gentle daily prompts, prayer space, gratitude tracking, and room to carry your reset forward.',
    image: '/images/the-gentle-reset-book-cover.svg',
    imageAlt: 'The Gentle Reset paperback book cover by DivaglamKreation',
    href: links.theGentleResetBook,
    priceLabel: '$9.99 · Paperback',
    buttonLabel: 'Get It on Amazon',
    external: true,
    featured: true,
  },
  {
